    ...
    >
      <section className="w-full max-w-xl space-y-6 rounded-3xl border border-white/60 bg-white/80 p-6 text-center shadow-[0_18px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl sm:p-8">
        ...
        <a
          ...
          className="inline-flex h-14 w-full items-center justify-center rounded-2xl bg-gradient-to-r from-sky-400 to-blue-600 px-6 font-bold text-white shadow-[0_12px_30px_rgba(14,165,233,0.26)] transition-all duration-300 hover:-translate-y-0.5 focus:outline-none focus:ring-4 focus:ring-sky-200"
        >
          دانلود کارت
        </a>
      </section>
